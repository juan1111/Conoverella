...
<body>
  ...
  <section class="hero-section">a
    <div class="container text-center">
      <h1 class="display-4 fw-bold mb-4">Men's Collection</h1>
      <p class="lead mb-4">Elevate your style with our premium men's fashion</p>
    </div>
  </section>
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="d-flex flex-wrap">
            ...
            <button class="btn btn-outline-dark me-2 mb-2 filter-btn" data-filter="shirts">Shirts</button>
            <button class="btn btn-outline-dark me-2 mb-2 filter-btn" data-filter="pants">Pants</button>
            <button class="btn btn-outline-dark me-2 mb-2 filter-btn" data-filter="outerwear">Outerwear</button>
            <button class="btn btn-outline-dark mb-2 filter-btn" data-filter="suits">Suits</button>
          </div>
        </div>
        <div class="col-md-6">
